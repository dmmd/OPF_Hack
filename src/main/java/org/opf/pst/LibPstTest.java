...
public class LibPstTest{
    ...
    public LibPstTest() throws FileNotFoundException, PSTException, IOException {
...
private void getFolders(PSTFolder folderIn, int depth) throws PSTException, IOException{
        ...
        for(PSTFolder folder : folderIn.getSubFolders()){
			...
			if (folder.getContentCount() > 0) {
	            ...
	            while (email != null) {
	                System.out.println(sb.toString() + "Subject: "+email.getSubject() + " FROM: " + email.getDisplayName());
